 ...
 */
@WebServlet(name = "LoadEmployees", urlPatterns = {"/LoadEmployees"})
public class LoadEmployees extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Employee> listEMPLOYEEs = EMPLOYEEBean.getListEmployees();
        request.setAttribute("list", listEMPLOYEEs);
