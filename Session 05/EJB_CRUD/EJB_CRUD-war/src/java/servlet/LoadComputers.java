 ...
 */
@WebServlet(name = "LoadComputers", urlPatterns = {"/LoadComputers"})
public class LoadComputers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Computer> listcomputers = computerBean.getListComputers();
        request.setAttribute("list", listcomputers);
