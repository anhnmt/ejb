 ...
 */
@WebServlet(name = "InsertComputer", urlPatterns = {"/InsertComputer"})
public class InsertComputer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean bl = computerBean.insertComputer(b);
        if (bl) {
            request.getRequestDispatcher("index.jsp").forward(request, response);
        } else {
            request.setAttribute("error", "Insert failed!");
            request.getRequestDispatcher("insertComputer.jsp").forward(request, response);
        }
    }
